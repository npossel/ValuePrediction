...
pipeline_t::pipeline_t(
    ...
    uint32_t  num_tag_bits,
    uint32_t  confmax,
    uint32_t  confinc,
    uint32_t  confdec,
    uint32_t  replace_stride,
    uint32_t  replace,
    bool      predintalu,
    bool      predfpalu,
    bool      predload,
    bool      vpq_full_policy
):
  ...
  LSU(lq_size, sq_size, Tid, _mmu, this)
{
  ...
  ////////////////////////////////////////////////////////////
  // Set up the value predictor
  ////////////////////////////////////////////////////////////
  VP = new vp(vp_enable, vp_perf, vpqsize, oracleconf, num_index_bits, num_tag_bits, 
              confmax, confinc, confdec, replace_stride, replace, predintalu, predfpalu, 
              predload, vpq_full_policy);
...
pipeline_t::~pipeline_t()
{
  ...
  VP->vp_stats(stats->get_counter("commit_count"), stats_log);
